...
def tutorial_create_root() -> py_trees.behaviour.Behaviour:
    ...
    scan_rotate = py_trees_ros.actions.ActionClient(
        ...
        action_goal=imc_ros_actions.FollowSingleReference.Goal(),  # noqa
        generate_feedback_message=lambda msg: "{:.2f}%%".format(msg.feedback.state),
